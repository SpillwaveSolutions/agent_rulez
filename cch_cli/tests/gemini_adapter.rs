use cch::adapters::gemini::{parse_event, translate_response};
use cch::models::{EventType, GeminiDecision, Response};
use serde_json::json;
...
fn test_parse_tool_event_maps_pre_tool_use() {
    ...
    assert_eq!(parsed.event.tool_name.as_deref(), Some("write_file"));
