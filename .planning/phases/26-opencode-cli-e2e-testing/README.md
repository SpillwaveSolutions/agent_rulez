...
This phase adds the OpenCode CLI adapter and scenarios to the E2E test harness established in Phase 23.

**Scenarios:**
1. `rulez opencode install` succeeds in clean workspace
